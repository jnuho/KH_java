...
/**
 * Servlet implementation class StudentInputNameEndServlet
 */
@WebServlet("/inputNameEnd")
public class StudentInputNameEndServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	
	//controller(servlet)와 service의 결합성 줄여줌
	private MybatisService service = new MybatisServiceImpl();
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public StudentInputNameEndServlet() {
        super();
