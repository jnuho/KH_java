...
pageEncoding="UTF-8"%>
<%@ page import="java.util.List,java.util.ArrayList, com.kh.member.model.vo.Member"%>
			...
			<div id="search-container">
				...
				<div id="search-userName">
					<form action="<%=request.getContextPath() %>/admin/memberFinder">
						...
						<input type="hidden" name="cPage" value="<%=cPage%>"/>
						<input type="text" placeholder="회원명으로 조회" value='<%="userName".equals(searchType)?searchKey:""%>'
						name="searchKeyword" size="25"/>
						<button type="submit">검색</button>
					</form>
				</div>
